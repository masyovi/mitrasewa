    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 py-8 space-y-8">
        ...
        <section
          ...
          className="reveal border-b border-gray-100 pb-8"
        >
        ...
        <section className="animate-fade-in-up border-b border-gray-100 pb-8">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-1 h-6 bg-emerald-500 rounded-full" />
          ...
          <Card className="border-0 shadow-md bg-white overflow-hidden card-elevated">
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-emerald-500 px-5 sm:px-6 py-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-white font-bold text-sm sm:text-base">Pertanyaan Umum</p>
                <p className="text-white/70 text-xs">Jawaban atas pertanyaan yang sering diajukan</p>
              </div>
            </div>
            <CardContent className="p-5 sm:p-6">
              <div className="space-y-3">
                {[
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-gray-50 rounded-xl overflow-hidden transition-all hover-lift border-l-[3px] border-emerald-400"
                    >
                      <button
                        onClick={() => setOpenFaqIndex(isOpen ? null : idx)}
                        className="w-full flex items-center justify-between gap-3 p-4 text-left transition-colors hover:bg-gray-100"
                      >
