      ...
      <div className="grid grid-cols-1 min-[480px]:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-gradient-to-br from-emerald-50 to-white rounded-xl p-3 sm:p-4 flex items-center gap-3 animate-fade-in-up">
          ...
          <div className="min-w-0">
            <p className="text-lg sm:text-xl font-bold text-emerald-700 animate-count-up stat-number">
              {sewaBaruBulanIni}
            </p>
            <p className="text-[11px] sm:text-xs text-emerald-600 truncate">Sewa Baru Bulan Ini</p>
          </div>
        </div>
        <div className="bg-gray-50 rounded-xl p-3 sm:p-4 flex items-center gap-3 animate-fade-in-up animate-fade-in-up-delay-1">
          <div className="bg-gray-100 p-2 rounded-lg flex-shrink-0">
            <RotateCcw className="w-4 h-4 text-gray-600" />
          </div>
          <div className="min-w-0">
            <p className="text-lg sm:text-xl font-bold text-gray-700 animate-count-up stat-number">
              {sewaKembaliBulanIni}
            </p>
            <p className="text-[11px] sm:text-xs text-gray-500 truncate">Sewa Kembali Bulan Ini</p>
          </div>
        </div>
        <div className="bg-blue-50 rounded-xl p-3 sm:p-4 flex items-center gap-3 animate-fade-in-up animate-fade-in-up-delay-2">
          <div className="bg-blue-100 p-2 rounded-lg flex-shrink-0">
            <Timer className="w-4 h-4 text-blue-600" />
          </div>
          <div className="min-w-0">
            <p className="text-lg sm:text-xl font-bold text-blue-700 animate-count-up stat-number">
              {rataRataDurasi}
            </p>
            <p className="text-[11px] sm:text-xs text-blue-600 truncate">Rata-rata Durasi (hari)</p>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {popularEquipment.map((eq, idx) => {
                ...
                return (
                  <div
                    key={eq.item}
                    className="bg-gray-50 rounded-xl p-4 transition-colors hover:bg-gray-100"
                  >
                    <div className="flex items-center justify-between mb-2">
        ...
        <CardContent>
          {recentActivities.length === 0 ? (
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="absolute left-[11px] top-2 bottom-2 w-0.5 bg-gray-200 hidden sm:block" />
              <div className="space-y-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="hidden sm:flex flex-col items-center relative z-10 flex-shrink-0 w-[22px]">
                        <div
                          className={`w-3 h-3 rounded-full ${dotColor} ring-4 ring-white flex-shrink-0`}
                        />
                      </div>
                      ...
                      <div className="flex-1 min-w-0">
                        {/* Desktop version */}
                        <div className="hidden sm:block bg-gray-50 rounded-xl p-3.5 hover:bg-gray-100 transition-colors">
                        ...
                        <div className="sm:hidden bg-gray-50 rounded-xl p-3 flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2 min-w-0">
                            <div
