      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="animate-fade-in-up">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-xl font-bold text-gray-800">Laporan Analitik</h2>
          </div>
        ...
        >
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="h-9 gap-1.5 text-emerald-700 border-emerald-200 hover:bg-emerald-50"
            disabled={loading}
          >
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-100">
                        ...
                        <th className="text-right py-2.5 px-3 font-medium text-gray-500 text-xs uppercase tracking-wider hidden sm:table-cell">
                          Visualisasi
                        </th>
                      </tr>
                    </thead>
                    ...
                    {data.topItems.map((item, idx) => {
                      ...
                      return (
                        <div key={item.item} className="space-y-1.5">
                          ...
                          <div className="ml-7 h-2.5 bg-gray-100 rounded-full overflow-hidden">
                            <div
